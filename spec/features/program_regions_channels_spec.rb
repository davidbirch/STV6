...
describe "programs-by-region-and-channel: " do
  ...
  describe "navigate to the programs-by-region-and-channel page" do
    it "should display the programs-by-region-and-channel page" do
      within('ul#nav-guide') {click_link('By Region And Channel')}
      
      expect(page).to have_content("Signed in as mockuser")
      expect(page).to have_content("By Region And Channel")
