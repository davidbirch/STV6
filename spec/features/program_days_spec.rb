...
describe "programs-by-day: " do
  ...
  describe "navigate to the programs-by-day page" do
    it "should display the programs-by-day page" do
      within('ul#nav-guide') {click_link('By Day')}
      
      expect(page).to have_content("Signed in as mockuser")
      expect(page).to have_content("Programs By Day")
