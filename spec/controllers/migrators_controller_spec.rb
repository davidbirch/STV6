...
RSpec.describe MigratorsController, type: :controller do
  ...
  # Migrator. As you add validations to Migrator, be sure to
  ...
  # MigratorsController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET #index" do
    it "assigns all migrators as @migrators" do
      migrator = Migrator.create! valid_attributes
  ...
  describe "GET #show" do
    it "assigns the requested migrator as @migrator" do
      migrator = Migrator.create! valid_attributes
      get :show, {:id => migrator.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested migrator as @migrator" do
      migrator = Migrator.create! valid_attributes
      get :edit, {:id => migrator.to_param}, valid_session
      expect(assigns(:migrator)).to eq(migrator)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Migrator" do
        expect {
          post :create, {:migrator => valid_attributes}, valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved migrator as @migrator" do
        post :create, {:migrator => invalid_attributes}, valid_session
        expect(assigns(:migrator)).to be_a_new(Migrator)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested migrator" do
        migrator = Migrator.create! valid_attributes
        put :update, {:id => migrator.to_param, :migrator => new_attributes}, valid_session
        migrator.reload
      ...
      it "assigns the requested migrator as @migrator" do
        migrator = Migrator.create! valid_attributes
        put :update, {:id => migrator.to_param, :migrator => valid_attributes}, valid_session
        expect(assigns(:migrator)).to eq(migrator)
      end
    ...
    context "with invalid params" do
      it "assigns the migrator as @migrator" do
        migrator = Migrator.create! valid_attributes
        put :update, {:id => migrator.to_param, :migrator => invalid_attributes}, valid_session
        expect(assigns(:migrator)).to eq(migrator)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested migrator" do
      migrator = Migrator.create! valid_attributes
      expect {
        delete :destroy, {:id => migrator.to_param}, valid_session
      }.to change(Migrator, :count).by(-1)
    end
